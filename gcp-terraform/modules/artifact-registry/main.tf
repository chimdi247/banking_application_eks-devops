...
# =============================================================================
# Pattern: a single Artifact Registry repository (default: "banking-platform-registry")
# holds all the service images. On GCP, image URLs look like:
#
#   <region>-docker.pkg.dev/<project>/<repo>/<image>:<tag>
#
# e.g. us-central1-docker.pkg.dev/my-project/banking-platform-registry/auth-service:1.0.0
#
...
resource "google_artifact_registry_repository" "this" {
  ...
  description   = "${var.name_prefix} — all banking-platform container images"
  format        = "DOCKER"
  labels        = var.labels
